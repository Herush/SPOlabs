...
laba1spo - program to do something

# SYNOPSIS

**laba1spo** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**laba1spo** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **laba1spo** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**laba1spo** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    laba1spo. See **foo.conf**(5) for further details.
...
**laba1spo** provides some return codes, that can be used in scripts:
